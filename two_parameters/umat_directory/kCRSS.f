...
********************************************************
      ...
      SUBROUTINE kCRSS(iphase,tauc,nSys,G12,burgerv,gndtot,irradiate,implanted,
     ...
     + twinvolfractotal,twinon)
      ...
      if (iphase == 1) then
          ...
          tauc = tauc + 0.01*G12*(burgerv(1))*sqrt(gndtot)
          ...
          ! Taylor dislocation law
          tauc = tauc + 0.32*G12*(burgerv(1))*sqrt(gndtot)
