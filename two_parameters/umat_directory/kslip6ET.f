...
C     
        !originally used for BCC material
      if (iphase == 1) then
          
          rhom =  0.01 !mobile dislocation density 
          dF = 4.646E-8 !(new value is 0.29eV for iron https://journals.aps.org/prmaterials/pdf/10.1103/PhysRevMaterials.1.053603)   3.4559E-8 = 0.22eV !! Energy barrier microN.microns = pJ          
      ...
      !originally used for FCC material  
